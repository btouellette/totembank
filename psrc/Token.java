...
public class Token implements Serializable{
	...
	private ArrayList<Integer> retransList;	//retransmission list
	...
	public Token(int ring){
		...
		seqNum = 0;
		aru = 0;
		retransList = new ArrayList<Integer>();		
	}
	...
	public ArrayList<Integer> getRetranList(){
		return retransList;
	}
	
	public void setRetranList( ArrayList<Integer> retransList ){
